...
int Login(char lnom[20], char lpword[20]) // Mira si la persona la persona que se intenta loguear existe y si su contraseña es correcta. Retorna 1 si hay errores, 0 si esta todo correcto, -1 si la persona no existe o la contraseña es incorrecta
{
	MYSQL *conn;
	int err;
	//++++++++++++++++++++++++++++++++++Almacenar consulta
